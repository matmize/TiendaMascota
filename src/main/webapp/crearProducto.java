...
public class CrearProducto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
        ...
        int codigo = req.getParameter("codigo");
        String nombre = req.getParameter("nombre");
        String descripcion = req.getParameter("descripcion");
        int valorUni = req.getParameter("valorUni");
        int cantidad = req.getParameter("cantidad");

        String rpta = "ya existe un producto con el codigo " + codigo;
        String rpta1 = "Se ha creado un producto con el codigo" + codigo;

        if (unico.buscarProducto(codigo).codigo == -100){
