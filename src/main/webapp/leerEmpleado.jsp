       ...
       <%
            ...
            <%}else{%>
                <Table>
                    ...
                    <tr><td><Strong><%= unico.buscarEmpleado(id).idEmpleado%> </Strong></td><tr><td><Strong><%= unico.buscarEmpleado(id).nombreEmpleado%> </Strong></td><tr><td><Strong><%= unico.buscarEmpleado(id).habilidades%> </Strong></td>
